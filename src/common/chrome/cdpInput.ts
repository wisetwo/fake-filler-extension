...
import { type KeyDefinition, type KeyInput, _keyDefinitions } from "src/shared/us-keyboard-layout";
...
export class CdpKeyboard {
  ...
  async press(key: KeyInput | KeyInput[], options: Readonly<KeyPressOptions> = {}): Promise<void> {
