...
export function isButtonElement(node: globalThis.Node): node is globalThis.HTMLButtonElement {
  return node instanceof HTMLElement && node.tagName.toLowerCase() === "button";
}

export function isAElement(node: globalThis.Node): node is globalThis.HTMLButtonElement {
  return node instanceof HTMLElement && node.tagName.toLowerCase() === "a";
}

export function isImgElement(node: globalThis.Node): node is globalThis.HTMLImageElement {
...
export function isTextElement(node: globalThis.Node): node is globalThis.HTMLTextAreaElement {
  return node.nodeName?.toLowerCase() === "#text" && !isIconfont(node);
}

export function isContainerElement(node: globalThis.Node): node is globalThis.HTMLElement {
